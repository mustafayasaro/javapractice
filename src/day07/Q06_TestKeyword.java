...
*/
    ...
    public static void notlar(char[][] answers, char[] keys) {


        for (int i = 0; i < answers.length; i++) { // i ogrenciyi temsil ediyor
            int correctCount = 0; // herbir ogrencinindogru cevabini sayacagi icin sayac buraya konur
